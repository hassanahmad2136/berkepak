...
const products = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1597484211029-f07cc5ec00a3?q=80&w=600&auto=format&fit=crop"
  },
  {
    id: "p-032",
    slug: "hi-silky",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1528459199954-0d107384a5d3?q=80&w=600&auto=format&fit=crop"
  },
  {
    id: "p-056",
    slug: "topaz",
...
const mappedProducts = products.map(p => {
  const pricePerMeter = Math.round((p.pricePerSuit / p.metersPerSuit) / 10) * 10;
  return {
    id: p.id,
    slug: p.slug,
    name: p.name,
...
const STATIC_PRODUCTS: Product[] = ${JSON.stringify(mappedProducts, null, 2)};
...
fs.writeFileSync('/Users/abdullah/code/BerkePak/web/src/lib/products.ts', fileContent);
